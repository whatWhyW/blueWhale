...
import BreadcrumbCustom from '../../Layout/BreadcrumbCustom/index';
import { Card, Avatar, Row, Col, Progress, Timeline, Collapse, Table, Icon } from 'antd';
import zysoft from '../../../static/images/avatar.jpg';
import './index.less';
            ...
            return(
                <Col md={6} key={item}>
                    <Card style={{cursor:'pointer', marginBottom:16}}
                        ...
                        <Meta
                            style={{fontSize:22}}
                            avatar={<img src={require('../../../static/images/'+item+'.png')} alt=""/>}
                            title={imgName[index]}
                            ...
                            <Card
                                ...
                                <div className='weather'>
                                    ...
                                    <div className='weather-img'>
                                        <img src={require('../../../static/images/0.png')} alt=""/>
                                    </div>
